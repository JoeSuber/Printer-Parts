...
module hangbase(cB=25){
	difference(){
		...
		hull(){
			translate([0,0,cB/2])
				cylinder(r=6.4, h=5.75, center=true, $fn=6); //captured nut
			translate([15,0,cB/2])
				cylinder(r=6.4, h=5.75, center=true, $fn=6); 
		}
			...
			translate([0,-cB/2-6.8/2,cB*1.12]) rotate([0,90,90])
				cylinder(r=7.45, h=6.8, center=true, $fn=6);
			translate([0,cB/2+6.8/2,cB*1.12]) rotate([0,90,-90])
				cylinder(r=7.45, h=6.8, center=true, $fn=6);
			// m4 side-punch holes
...
fourby();
translate([cB-7,0,cB-3]) rotate([0,-90,0])
	bnb();
//translate([0,-cB*1.5,cB/2+cB/6]) rotate([0,-90,0])
//	bnb();
//translate([0,+cB*1.5,cB/2+cB/6]) rotate([0,-90,0])
//	bnb();